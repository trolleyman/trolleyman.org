table! {
    /// Representation of the `facebook_account` table.
    ///
    /// (Automatically generated by Diesel.)
    facebook_account (id) {
        /// The `id` column of the `facebook_account` table.
        ///
        /// Its SQL type is `Integer`.
        ///
        /// (Automatically generated by Diesel.)
        id -> Integer,
        /// The `user_id` column of the `facebook_account` table.
        ///
        /// Its SQL type is `Integer`.
        ///
        /// (Automatically generated by Diesel.)
        user_id -> Integer,
        /// The `email` column of the `facebook_account` table.
        ///
        /// Its SQL type is `Text`.
        ///
        /// (Automatically generated by Diesel.)
        email -> Text,
        /// The `password` column of the `facebook_account` table.
        ///
        /// Its SQL type is `Text`.
        ///
        /// (Automatically generated by Diesel.)
...
table! {
    ...
    git_lfs_object (id) {
        ...
        /// (Automatically generated by Diesel.)
        size -> BigInt,
        /// The `valid` column of the `git_lfs_object` table.
        ///
...
joinable!(facebook_account -> user (user_id));
