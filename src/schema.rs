...
table! {
    ...
    ///
    /// (Automatically generated by Diesel.)
    git_lfs_upload_token (id) {
        /// The `id` column of the `git_lfs_upload_token` table.
        ///
        /// Its SQL type is `Integer`.
        ///
        /// (Automatically generated by Diesel.)
        ...
        /// (Automatically generated by Diesel.)
        token -> Text,
        /// The `repository` column of the `git_lfs_upload_token` table.
        ///
        /// Its SQL type is `Integer`.
        ///
        /// (Automatically generated by Diesel.)
...
joinable!(git_lfs_upload_token -> git_lfs_repository (repository));
